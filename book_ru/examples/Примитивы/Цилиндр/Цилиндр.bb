...
cyl=CreateCylinder() ;создание цилиндра(в скобках показывают число от 3 до 100, которое показывает из скольких сегментов состоит цилиндр)

PositionEntity cyl,0,0,4 ;позиция объекта
